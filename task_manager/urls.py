...
from tasks.views import (tasks_view, completed_tasks_view, all_tasks_view, add_tasks_view, delete_tasks_view, complete_task_view, remove_tasks_view)
...
urlpatterns = [
    ...
    path('remove-task/<int:id>/', remove_tasks_view),
